...
public class DESEncrypt {
	public static final String key = "AD67EA2F3BE6E5AD";
	
    public static void main(String[] args) throws UnsupportedEncodingException {

    	String key = "AD67EA2F3BE6E5AD";
    	// String a = URLEncoder.encode("http://192.1.17.36:2010/esmp-web/html/sx/bulletin/bulletinList.html?a=1&b=2&c=3","utf-8");
//    	String data = "{\"userCode\":\"919159000\",\"reqDate\":\"20181128105436\",\"service\":\"http://127.0.0.1:8088/bssCustManage/jsp/custView/custBasisView/custAllViewInit.jsp\",\"reqData\":{\"latnId\":\"919\",\"accNbr\":\"15309197376\",\"productId\":\"41010300\"}}";
//    	String str = DESEncrypt.strEnc(data, key);
    	String data= "{ \"contractRoot\": { \"tcpCont\": { \"transactionId\": \"4a3721cb-fd5e-4a38-8a65-bb3dace994f3\", \"reqTime\": \"2019-11-15 11:58:09\", \"sign\":\"xxxx\" }, \"svcCont\": { \"businessParams\": { \"payUserId\": \"982095089\", \"payUserSerial\": \"2019111511119518921xxxxxxx\", \"tenantAccount\" : \"290\", \"latnId\" : 290 , \"orgId\"  : 893, \"staffId\": 893, \"sysUserCode\": 893, \"commodityName\":\"电信缴费（订单号：100675892）\", \"commodityDesc\":\"电信缴费（订单号：100675892，本地网：山南分公司）\", \"orderTime\":\"20200101121212\",\"amount\":\"500\", \"tradeTypeId\" :\"1\", \"objType\" :\"1\",\"objId\" :\"1\" }, \"encryptValue\": \"9DB930C4C0CB7B06\" } } }";
    	String result = DESEncrypt.strEnc(data, key);
    ...
    public static String strEnc(String data,String firstKey, String secondKey){
    	return strEnc(data, firstKey, secondKey, null);
    }
    
    public static String strDec(String data,String firstKey, String secondKey){
    	return strDec(data, firstKey, secondKey ,null);
    }
